...
**원인 A:** COM↔XML 단절 → XML 라우팅 제거, COM 우선 검색 (v0.5.5)
**원인 B:** DOCX/HTML 타임아웃 → not_supported 즉시 반환 (v0.5.3)
**원인 D:** COM 상태 관리 → 표 중복 감지 + MovePos(2) + 캐시 초기화 (v0.5.4~v0.5.6)
**원인 E:** PDF 렌더링 → save 선행 3곳 (v0.5.2)
**원인 F:** 에러 대화상자 → validate_file_path 경로/권한/잠금 사전 검증 (v0.5.6)
